...
export default () => Base({ appName: 'Resicon Pack - Flat' })

const inter = Inter({ subsets: ['latin'], display: 'block' })
const lexend = Lexend_Deca({ subsets: ['latin'], display: 'block' })

export function Base({ appName }) {
  return (
    <>
      <Head>
        <title>Privacy Policy - Sarsa Murmu</title>
      ...
      <div className={`${s.container} ${inter.className}`}>
        ...
        <p>Sarsa Murmu built the {appName} app as a Commercial app. This SERVICE is provided by
          Sarsa Murmu and is intended for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          called Log Data. This Log Data may include information such as your device Internet Protocol (&ldquo;IP&rdquo;) address,
        ...
        <p>
          This Service does not use these &ldquo;cookies&rdquo; explicitly. However, the app may use third party code and
          libraries that use &ldquo;cookies&rdquo; to collect information and improve their services. You have the option to
        ...
        <p>
          ...
          me at sarsamurmu05@gmail.com.
        </p>
        <p>This privacy policy page was created at <a href="https://privacypolicytemplate.net" target="_blank">privacypolicytemplate.net</a>    and modified/generated by <a href="https://app-privacy-policy-generator.firebaseapp.com/" target="_blank">
          App
